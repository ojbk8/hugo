...
func (b *sourceFilesystemsBuilder) Build() (*SourceFilesystems, error) {
	...
	dataFs, err := hugofs.NewSliceFs(hugofs.ToFileMetas(b.theBigFs.dataDirs...)...)
	if err != nil {
		return nil, err
	}
	...
	contentFs, err := hugofs.NewLanguageFs(b.p.Languages.AsSet(), hugofs.ToFileMetas(contentDirs...)...)
	if err != nil {
